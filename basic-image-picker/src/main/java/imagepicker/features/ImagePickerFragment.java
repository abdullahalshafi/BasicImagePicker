...
import imagepicker.features.camera.CameraHelper;
import imagepicker.features.camera.DefaultCameraModule;

import imagepicker.features.cameraonly.CameraOnlyConfig;
import imagepicker.features.common.BaseConfig;
import imagepicker.features.fileloader.DefaultImageFileLoader;
import imagepicker.features.recyclers.RecyclerViewManager;
import imagepicker.helper.ConfigUtils;
import imagepicker.helper.ImagePickerPreferences;
import imagepicker.helper.IpCrasher;
import imagepicker.helper.IpLogger;
import imagepicker.model.Folder;
import imagepicker.model.Image;
import imagepicker.view.SnackBarView;
...
import static imagepicker.helper.ImagePickerPreferences.PREF_EXTERNAL_STORAGE_REQUESTED;
